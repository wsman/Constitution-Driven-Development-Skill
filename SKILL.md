...
- **📍 从检查点继续**：`active_context.md` (位于 `memory_bank/t0_core/`) → 读取上次状态，继续工作流
...
**检查点检测流程**：
1. **检测检查点**：检查 `memory_bank/t0_core/active_context.md` 是否存在
...
```
templates/
├── t0_core/          # T0 核心层 (5-dimensional truth representation)
│   ├── active_context.md
│   ├── knowledge_graph.md
│   ├── basic_law_index.md
│   ├── procedural_law_index.md
│   └── technical_law_index.md
├── t1_axioms/        # T1 公理层 (invariant physical laws)
│   ├── system_patterns.md
│   ├── tech_context.md
│   └── behavior_context.md
├── t2_protocols/     # T2 工作流协议 (execution processes)
...
│   ├── WF-review.md
│   └── WF-sync-issues.md
├── t2_standards/     # T2 实现标准 (legislative documents)
│   ├── DS-007_context_management.md
│   ├── DS-050_feature_specification.md
│   ├── DS-051_implementation_plan.md
│   ├── DS-052_atomic_tasks.md
│   ├── DS-053_quality_checklist.md
│   ├── DS-054_environment_hardening.md
│   └── DS-060_code_review.md
└── t3_documentation/ # T3 用户/开发者文档 (User & Developer Documentation)
    ├── index.md                   # T3 文档索引
    ├── quickstart.md              # 快速入门指南
    ├── getting-started.md         # 开发环境配置指南
    ├── overview.md                # 架构概览文档
    └── api-reference.md           # API 参考文档
```

**Reference Templates** (located in `reference/`):
- `06_project_readme_template.md` - For project initialization (自动映射到 `t0_core/project_readme_template.md`)
- `07_feature_readme_template.md` - For feature development (generated by `cdd-feature.py`, 自动映射到 `t2_standards/feature_readme_template.md`)
